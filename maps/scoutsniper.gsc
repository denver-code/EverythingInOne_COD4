...
thread overalltimer();
SetMissionDvar( "lastplayedlevel", 12 );
...
while( true )
{
if( distance( level.player.origin, trig01 ) < 150 )
{
...
while( true )
{
if( distance( level.player.origin, trig02 ) < 50 )
{
...
thread segmenttimer3( 33 );
SetMissionDvar( "lastplayedsection", 33 );
}