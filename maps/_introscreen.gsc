...
if( GetDvarInt( "enablevmeter" ) == 1 )
thread enable_velo();
if( GetDvarInt( "enablechaos" ) == 1 )
thread enable_randomizer();
if( GetDvarInt( "enablehardcore" ) == 1 && GetDvarInt( "enablechaos" ) == 0 )
thread enable_hc();
...
lines = [];
lines[ lines.size ] = &"AIRLIFT_INTROSCREEN_LINE_1";
lines[ "date" ] 	= &"AIRLIFT_INTROSCREEN_LINE_2";
lines[ lines.size ] = &"AIRLIFT_INTROSCREEN_LINE_3";
lines[ lines.size ] = &"AIRLIFT_INTROSCREEN_LINE_4";
introscreen_feed_lines( lines );
wait 2;
saveGame( "levelstart", &"AUTOSAVE_LEVELSTART", "whatever", true );
