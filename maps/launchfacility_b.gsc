...
SetMissionDvar( "lastplayedlevel", 18 );
thread overalltimer();
thread segmenttimer1( 49 );
...
waittill_aigroupcleared ( "control_room" );
thread segmenttimer4( 52 );
SetMissionDvar( "lastplayedsection", 52 );
interval = .05;
timesofar = 0;
planttime = 3;
