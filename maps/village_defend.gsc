...
SetMissionDvar( "lastplayedlevel", 14 );
thread overalltimer();
...
thread segmenttimer4( 41 );
SetMissionDvar( "lastplayedsection", 41 );
}
if ( isdefined( tank ) )
{
