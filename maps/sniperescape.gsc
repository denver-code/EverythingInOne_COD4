...
SetMissionDvar( "lastplayedlevel", 13 );
thread overalltimer();
thread segmenttimer1( 34 );
...
thread segmenttimer4( 37 );
SetMissionDvar( "lastplayedsection", 37 );
