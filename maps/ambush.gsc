...
SetMissionDvar( "lastplayedlevel", 15 );
thread overalltimer();
thread segmenttimer1( 42 );
SetMissionDvar( "lastplayedsection", 42 );
...
thread segmenttimer3( 44 );
SetMissionDvar( "lastplayedsection", 44 );
}